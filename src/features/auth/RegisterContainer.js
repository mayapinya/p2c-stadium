      ...
      <div className="container mx-auto main d-flex flex-column justify-content-center box-register">
        <div className="panel">
          ...
          <div className="panel-content">
            <div className="mb-3">
              <label for="first-name-control" className="form-label">
                ชื่อ
              </label>
              <input
                type="text"
            ...
            <div className="mb-3">
              <label for="last-name-control" className="form-label">
                นามสกุล
              </label>
              <input
                type="text"
            ...
            <div className="mb-3">
              <label for="email-control" className="form-label">
                อีเมล์
              </label>
              <input
                type="email"
            ...
            <div className="mb-3">
              <label for="password-control" className="form-label">
                รหัสผ่าน
              </label>
              <input
                type="password"
            ...
            <div className="mb-3">
              <label for="re-password-control" className="form-label">
                ยืนยันรหัสผ่าน
              </label>
              <input
                type="password"
